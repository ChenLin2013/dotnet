...
Write a console application in the .Net language of your choice which accepts any string/text that can be entered using the key assignments in the grid.  The application should calculate, and display in the console window, the minimum time required to input using the key pad and the sequence of keys that would be required.
